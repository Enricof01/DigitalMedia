    ...
    <main className="main">
      ...
      <div className="story" ref={storyRef}>
        <div className="sticky">
          ...
          <div className="eyebrow-top">Eine Kampagne gegen die stille Zeitverschwendung</div>
      ...
      <footer className="site-footer">
        <div className="footer-inner">
          ...
          <div className="footer-text">Diese Seite hat keine App. Kein Like-Button. Kein Algorithmus.<br />Nur eine Frage: Was machst du mit deiner Zeit?</div>
        </div>
      </footer>
